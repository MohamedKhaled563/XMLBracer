...
public:
    ...
    QPlainTextEdit *originalXml;
    QPushButton *Open_File;
    QPlainTextEdit *modifiedXml;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        originalXml = new QPlainTextEdit(verticalLayoutWidget);
        originalXml->setObjectName(QString::fromUtf8("originalXml"));

        verticalLayout_5->addWidget(originalXml);
        ...
        modifiedXml = new QPlainTextEdit(verticalLayoutWidget);
        modifiedXml->setObjectName(QString::fromUtf8("modifiedXml"));

        verticalLayout_5->addWidget(modifiedXml);
